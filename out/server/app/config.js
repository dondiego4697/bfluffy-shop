...
const development = Object.assign(Object.assign({}, testing), { 'logger.colorize': true, 'logger.level': 'silly', 'cors.allowedOrigins': null, 'csrf.enable': false, 'app.cache.enable': false, db: Object.assign(Object.assign({}, testing.db), { hosts: ['localhost', 'localhost'], port: 6432, username: 'postgres', password: 'password', database: 'petstore' }) });
